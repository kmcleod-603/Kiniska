  ...
  if (str && str !== '') {
    ...
    return JSON.parse('{"' +
      str
        ...
        .join('","')
      + '"}', function (key, value) {
        return key === "" ? value : /%[0-9a-f]{2}/i.test(value) ? decodeURIComponent(value) : value //decodeURIComponent(value)
      })
  }
  return {}
}

export const getCookie = (key) => typeof document === 'undefined' ? null : queryOrCookieStrToObj(document.cookie, /[;]\s?/g)[key]
